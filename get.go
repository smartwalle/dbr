...
type BlockOption func(opt *blockOption)

func WithBlockValue(blockValue string) BlockOption {
	return func(opt *blockOption) {
...
func (this *Client) getBlock(ctx context.Context, key string, opt *blockOption) (bool, string, error) {
